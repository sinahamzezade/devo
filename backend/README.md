# Smart Insurance Application Portal - Backend

This is the backend API for the Smart Insurance Application Portal, built with NestJS, TypeORM, and SQLite.
...
- SQLite database with migrations for easy setup
...
- `GET /api/insurance/forms/submissions` - Get all submitted applications
...
The application uses SQLite with the database file located at `data/insurance.sqlite`. The initial migration will create all necessary tables and seed them with sample form templates.
